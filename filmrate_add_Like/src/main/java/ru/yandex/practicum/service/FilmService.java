...
public class FilmService {
    ...
    public Film update(Film newFilm) {
        ...
        if (!errors.isEmpty()) {
            log.error("Валидация фильма не пройдена: {}", newFilm.getId());
            throw new ValidationException(String.join(",", errors));
        }
    ...
    public void updateFilmFields(Film oldFilm, Film newFilm) {
